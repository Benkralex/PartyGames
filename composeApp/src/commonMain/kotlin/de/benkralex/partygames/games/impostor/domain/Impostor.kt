...
class Impostor : Game<ImpostorSettings, ImpostorDataset>() {
    ...
    /**
     * Initializes this Impostor game with the provided settings and marks it as the active game.
     *
     * @param settings The ImpostorSettings to apply (players, impostorCount, topics, optional hint). 
     */
